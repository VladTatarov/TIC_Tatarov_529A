...
def plot(x, y, axis_x="", axis_y="", title=""):
    """Построение графика x-y с указанными подписями осей и заголовком."""
...
def spectrum(sequence):
    """Вычисление спектра последовательности."""
    ...
    return x_spectrum[len(x_spectrum) // 2:], y_spectrum[len(y_spectrum) // 2:]


def create_sequence():
    """Генерация случайной цифровой последовательности с длительностью бита 100 отсчётов."""
